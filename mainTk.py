...
class Display():
    def __init__(self, win):
        ...
        self.communText = tk.StringVar()
        self.communTextLab = tk.Label(self.encryptFrame, text = "Enter the commun text : ")
        self.communTextEnt = tk.Entry(self.encryptFrame, textvariable = self.communText, width = 40)
        self.encryptText = tk.StringVar()
        self.encryptTextLab = tk.Label(self.encryptFrame, text = "Enter the text to encrypt : ")
        self.encryptTextEnt = tk.Entry(self.encryptFrame, textvariable = self.encryptText, width = 40)
        self.dictioLab = tk.LabelFrame(self.encryptFrame, text = "Choose dictionnaries to use : ")
        self.dictioToUse = tk.Listbox(self.dictioLab)
        for i in self.dictio:
            self.dictioToUse.insert("end", i)
        self.encryptTextButton = tk.Button(self.encryptFrame, text = "Encrypt", command = _kTk.encrypt)
    ...
    def encryptS(self):
        ...
        self.communTextLab.pack()
        self.communTextEnt.pack()
        self.encryptTextLab.pack()
        self.encryptTextEnt.pack()
        self.dictioLab.pack()
        self.dictioToUse.pack()
        self.encryptTextButton.pack()
        self.saveInFile.pack()
        self.dictioToUse.selection_set(keep.allDictio.index("default"))
    ...
    def back(self):
        ...
        self.communTextLab.pack_forget()
        self.communTextEnt.pack_forget()
        self.encryptTextLab.pack_forget()
        self.encryptTextEnt.pack_forget()
        self.dictioLab.pack_forget()
        self.dictioToUse.pack_forget()
        self.encryptTextButton.pack_forget()
